...
<?php 
    $statusmodalsql = "SELECT * FROM orders WHERE \"userId\" = $1";
    $statusmodalresult = pg_query_params($conn, $statusmodalsql, array($userId));
    while ($statusmodalrow = pg_fetch_assoc($statusmodalresult)) {
